...
var tree = render(products[1]);
var rootNode = createElement(tree);
document.body.appendChild(rootNode);

function update(id) {
	var newTree = render(products[i]);
	var patches = diff(tree, newTree);
	rootNode = patch(rootNode, patches);
	tree = newTree;
}

},{"./products":36,"virtual-dom/create-element":8,"virtual-dom/diff":9,"virtual-dom/h":10,"virtual-dom/patch":11}],36:[function(require,module,exports){
'use strict';
